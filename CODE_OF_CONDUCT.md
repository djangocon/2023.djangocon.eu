...
The CoC applies before and throughout the event (including related activities such as social events, and social media). We have also published our [response guidelines](https://2023.djangocon.eu/response-guide/).
...
Reach out to the Code of Conduct team at [conduct@djangocon.eu](mailto:conduct@djangocon.eu) or in person. Members are:
...
- Having a framework for report handling (see the [response guidelines](https://2023.djangocon.eu/response-guide/)). The Code of Conduct is the basis for dealing with a report, assessing whether the CoC was violated, and what action should be taken.
...
- Any conference related social activities in person and online
- Such as tweets with the conference hashtag, and other online media
...
If a Code of Conduct incident happens to you, or you witness it happening to someone else, please contact the CoC team immediately, by sending an email to [conduct@djangocon.eu](mailto:conduct@djangocon.eu).
...
- Your account of what occurred. If there is a written record (e.g. tweets or discord messages), please include screenshots and, if possible, a link.
...
When handling a report, we follow our [response guidelines](https://2023.djangocon.eu/response-guide/).
